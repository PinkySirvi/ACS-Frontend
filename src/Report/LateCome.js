...
const LateCome = () => {
    ...
    function getUsers() {
        fetch(`${process.env.REACT_APP_API_KEY}/latecomingreport`).then((result) => {
    ...
    return (
        <div>
            <div style={{ fontFamily: "sans-serif" }}> <h2><center>LATE COMING REPORT</center></h2> </div>
            ...
            <DataTable value={users} paginator rows={10}>
                ...
                <Column field="shiftcheckin" header="Shift Check-In"></Column>

...
const TimeCard = () => {
    ...
    function getUsers() {
        fetch(`${process.env.REACT_APP_API_KEY}/timecardreport`).then((result) => {
    ...
    return (
        <div>
            <div style={{ fontFamily: "sans-serif" }}> <h2><center>TIME CARD REPORT</center></h2> </div>
            ...
            <DataTable value={users} paginator rows={10}>
                ...
                <Column field="timehrs" header="TimeHrs"></Column>
